          ...
          {!currentSession ? (
            <div className="flex items-center justify-center h-full">
              <div className="text-center max-w-md">
                <div className="mb-4 inline-flex items-center justify-center w-16 h-16 rounded-full bg-[var(--color-accent-cyan)]/10">
                ...
                <button
                  onClick={handleClose}
                  className="px-4 py-2 bg-[var(--color-accent-cyan)] text-[var(--color-bg-primary)] rounded-lg hover:bg-[var(--color-accent-cyan-muted)] transition-colors font-medium"
                >
                  Close Panel
                </button>
              </div>

            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-64 px-4 py-3 bg-[#08062B] border border-[#1B1B61] rounded-lg text-[#e8eaf0] placeholder-[#a8b0c8]/50 focus:outline-none focus:border-[#d4af37] transition-colors duration-200 resize-none custom-scrollbar"
                />
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="px-3 py-2 bg-[#1B1B61]/30 rounded-lg border border-[#1B1B61]">
                      <div className="text-2xl font-bold text-[#d4af37]">{selectedCount}</div>
                      <div className="text-xs text-[#a8b0c8]">Selected Items</div>
                    </div>
                    <div className="px-3 py-2 bg-[#1B1B61]/30 rounded-lg border border-[#1B1B61]">
                      <div className="text-2xl font-bold text-[#d4af37]">{itemNotesCount}</div>
